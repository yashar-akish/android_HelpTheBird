package com.company.helpthebird;
...
public class GameActivity extends AppCompatActivity {
    ...
    public void collisionControl(){
        ...
        if (right > 0 && score < 200) {
            if (right == 2) {
                right1.setImageResource(R.drawable.grayheart);
            }
            if (right == 1) {
                right2.setImageResource(R.drawable.grayheart);
            }
            ...
            textViewStartInfo.setText("Congratulation. You WON the game.");
            ...
            handler.removeCallbacks(runnable);
            right3.setImageResource(R.drawable.grayheart);
